...
class CarroController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $dados = $request->all();
        // se o campo foi preenchido e enviado
    ...
    public function graf() {
        $sql = "select m.nome as marca, count(c.id) as num
                from carros c inner join marcas m on c.marca_id = m.id group by m.nome";
    ...
    public function destaque($id) {
        ...
        if ($dest){
            return redirect()->route('carros.index')
            ->with('status', ($destaque == "*" ? $car->modelo . ' destacado' : $car->modelo . ' retirado do destaque'));
        }
    }
}
